"""A simple CLI and for the package."""
...
def main(args: None | list[str] = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Parse Markdown using quickmark"
    )
    parser.add_argument(
        "--version",
        "-v",
    ...
    parser_ast = subparsers.add_parser(
        "ast", help="Render to Abstract Syntax Tree"
    )
    ...
    md = MDParser(parsed_args.config)
