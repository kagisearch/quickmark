...
class LinkExtensionPlugin(Plugin):
    def __init__(
        self,
...
class CitationExtensionPlugin(Plugin):
    def __init__(
        self,
...
class DisplayMathExtensionPlugin(Plugin):
    def __init__(
        self,
        cache: bool,
    ) -> None: ...
...
class InlineMathExtensionPlugin(Plugin):
    def __init__(
        self,
        cache: bool,
    ) -> None: ...
...
class MDParser:
    ...
    def __init__(
        self,
        config: Literal["commonmark", "gfm", "zero", "kagi"] = "commonmark",
    ) -> None:
        """Initialize a MDParser instance.
    ...
    def warmup(self) -> None:
        """run warmup for treesitter, so all configs are built to avoid runtime cost"""
