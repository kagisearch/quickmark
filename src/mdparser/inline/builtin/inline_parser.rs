use crate::mdparser::block::builtin::BlockParserRule;
use crate::mdparser::core::{CoreRule, Root};
use crate::mdparser::extset::{InlineRootExtSet, RootExtSet};
use crate::{MarkdownIt, Node, NodeValue};

#[derive(Debug)]
/// Temporary node which gets replaced with inline nodes when
/// [InlineParser](crate::mdparser::inline::InlineParser) is called.
