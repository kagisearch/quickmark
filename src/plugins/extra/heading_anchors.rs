//! Add id attribute (slug) to headings and optionally permalinks.
...
//!
//! ```rust
//! use quickmark::plugins::extra::heading_anchors::{
...
//
// Adapted from
//    - <https://github.com/Flet/markdown-it-github-headings>
//    - <https://github.com/executablebooks/mdit-py-plugins>
//    - <https://github.com/valeriangalliat/markdown-it-anchor>)

use crate::{
    mdparser::{core::CoreRule, extset::MarkdownItExt, inline::builtin::InlineParserRule},
    plugins::{
        cmark::block::{heading::ATXHeading, lheading::SetextHeader},
        extra::github_slugger::Slugger,
