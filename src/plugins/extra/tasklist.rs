...
//! let parser = &mut quickmark::MarkdownIt::new();
//! quickmark::plugins::cmark::add(parser);
//! quickmark::plugins::extra::tasklist::add(parser);
//! let root = parser.parse("- [x] task");
//! let mut names = vec![];
//! root.walk(|node,_| { names.push(node.name()); });
//! assert_eq!(names, vec![
//! "quickmark::mdparser::core::root::Root",
//! "quickmark::plugins::cmark::block::list::BulletList",
//! "quickmark::plugins::cmark::block::list::ListItem",
//! "quickmark::plugins::extra::tasklist::TodoCheckbox",
