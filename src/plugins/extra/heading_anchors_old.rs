...
//
//
// NOTE (matt): this is likely deprecated and replaced by heading_anchors.rs
//
//
...
//! let slugify_fn = quickmark::plugins::extra::heading_anchors::simple_slugify_fn;
//!
//! let md = &mut quickmark::MarkdownIt::new();
//! quickmark::plugins::cmark::add(md);
//! quickmark::plugins::extra::heading_anchors::add(md, slugify_fn);
//!
//! assert_eq!(
