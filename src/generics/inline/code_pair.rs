...
//!
//! ```rust
//! use quickmark::generics::inline::code_pair;
//! use quickmark::{MarkdownIt, Node, NodeValue, Renderer};
//!
//! #[derive(Debug)]
//! struct Ferris;
...
//!
use crate::mdparser::extset::{InlineRootExt, MarkdownItExt};
use crate::mdparser::inline::{InlineRule, InlineState, Text};
